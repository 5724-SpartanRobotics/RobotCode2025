...
public final class Elastic {
  ...
  /**
   * Sends an notification to the Elastic dashboard and prints it in the console. The notification
   * is serialized as a JSON string before being published.
   *
   * @param notification the {@link Notification} object containing notification details
   */
  public static Command sendNotificationAndPrintCommand(Notification notification) {
    System.out.println("Elastic is trying to print to console then send a notification.");
    return new InstantCommand(() -> {
      System.out.println(notification.level.toString() + ": " + notification.title + " -- " + notification.description);
