...
public final class Constants {
    ...
    public static final class ControllerConstants{
        public static double joystickXDeadband = 0.1;//a deadband that you must overcome for the joystick input, otherwise we send 0
        public static double joystickYDeadband = 0.1;//a deadband that you must overcome for the joystick input, otherwise we send 0
